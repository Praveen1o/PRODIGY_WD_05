    ...
    setTimeout(() => {
      ...
      hourly_data.map((data) => {
        ...
        temporary.innerHTML = `<div class="contain-hourly-data-child color2 vertical-align">
                ...
                <h5>Chance of Rain : <span id="rain">${
                  data.chance_of_rain
                }</span></h5>
                <h5>Chance of Snow : <span id="snow">${
                  data.chance_of_snow
                }</span></h5>
                </div>`;
      ...
      multi_data.map((data) => {
        ...
        temporary.innerHTML = `<div class="flex justify-content mt-1">
                ...
                <p>${
                  window.screen.width > 425 && window.screen.width < 1380
                    ? data.day.condition.text
                    : data.day.condition.text.slice(0, 15) + "..."
                }</p>
                <img src="${
                  data.day.condition.icon
                }" alt="abc" width="30" height="30">
                </div>
                </div>`;
